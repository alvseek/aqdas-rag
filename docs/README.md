...
**-0.284**. `calibrate.py` now carries both groups of off-topic question, so it reports
the overlap and suggests no floor rather than showing a clean gap on easy negatives
alone.
